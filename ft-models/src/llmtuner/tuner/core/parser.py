...
def get_train_args(
    ...
    model_args, data_args, training_args, finetuning_args, generating_args, gennm_args = parse_train_args(args)
    ...
    return model_args, data_args, training_args, finetuning_args, generating_args, gennm_args
...
def get_infer_args(
    ...
    model_args, data_args, finetuning_args, generating_args, gennm_args = parse_infer_args(args)
    ...
    return model_args, data_args, finetuning_args, generating_args, gennm_args
